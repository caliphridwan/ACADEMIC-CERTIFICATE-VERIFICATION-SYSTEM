...
<head>
    ...
    <title>Login | Online Academic Certificate Verification System</title>
                            ...
                            <div class="col-lg-4">
                                <div class="login-bg">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="logo">
                                                <h3 style="font-weight: bold;color: blue">Online Academic Certicate Verification System</h3>
                                                <hr />
                                            </div>
                                        </div>
                                    </div>
