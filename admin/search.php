...
<head>
    ...
    <title>Search | Online Academic Certificate System</title>
                                    ...
                                    <div class="datatable-dashv1-list custom-datatable-overright">
                                         ...
                                         <form method="post">
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-5">
                                                                    <label class="login2 pull-right pull-right-pro">Search by Application Number /Institution Attended/Full Name </label>
                                                                </div>
                                                                <div class="col-lg-7">
