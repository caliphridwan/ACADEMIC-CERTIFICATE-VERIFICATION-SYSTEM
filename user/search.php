...
<head>
    ...
    <title>Search | Online Academic Certificate Verification System</title>
...
$certificateno=$_POST['certificateno'];
  ...
  <h4 align="center">Result against Reg Mobile no. <?php echo $regmob;?> and Certificate no. <?php echo $certificateno;?>  </h4>
                                        ...
                                        <hr />
                                        <p align="left">This is to certify that the following information has been taken from the original record of Academics.</p>
