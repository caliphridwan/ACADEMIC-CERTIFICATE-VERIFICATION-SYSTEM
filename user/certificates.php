...
<head>
    ...
    <title>Manage Application Form | Online Academic Certificate System</title>
                            ...
                            <div class="sparkline13-list shadow-reset">
                                ...
                                <div class="sparkline13-graph">
                                    ...
                                    <div class="datatable-dashv1-list custom-datatable-overright">
                                        <h3 align="center">Academic Certificate</h3>
                                        <hr />
                                        <p align="left">This is to certify that the following information has been taken from the original record of the Academic Certificate.</p>
...
<strong> Application Number:</strong>   <?php  echo $row->ApplicationID;?></td></tr>
  ...
  <tr>
    ...
    <th scope>Institution Attended</th>
  ...
  <td><?php  echo $row->PermanentAdd;?></td>
   ...
   <tr>
    ...
    <th scope>Date of application</th>
