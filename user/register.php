...
echo "<script>alert('You have signed up  Succesfully');</script>";
}
else
{
...
<head>
    ...
    <title>Register | Online Academic Certificate System</title>
                            ...
                            <div class="col-lg-6">
                                <div class="login-bg">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="logo">
                                                <h3 style="font-weight: bold;color: blue">Online Academic Certificate Verification System</h3>
                                                <hr />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="login-input-area">
                                                <input type="text" name="mobno" maxlength="11" pattern="[0-9]+" required="true" />
