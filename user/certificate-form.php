...
$query->bindParam(':email',$email,PDO::PARAM_STR);
 $query->execute();
   ...
   if ($LastInsertId>0) {
    echo '<script>alert("Congratulations!!! Academic Certificate application successful")</script>';
...
echo "<script>alert('Date of Birth and Institution  already exists. Please try again');</script>";
...
<head>
    ...
    <title>Academic Certificate Form | Online Academic Certificate Verification System</title>
        ...
        <?php include_once('includes/header.php');?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Academic Registration Form</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                                ...
                                                <div class="all-form-element-inner">
                                                    ...
                                                    <form method="post">
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">Course of Study</label>
                                                                </div>
                                                                <div class="col-lg-9">
            ...
            <div class="form-group-inner">
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">Institution Attended</label>
                                                                </div>
                                                                <div class="col-lg-9">
                                                        ...
                                                        <div class="form-group-inner">
                                                         ...
                                                         <div class="form-group-inner">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                   <input type="text" class="form-control" required="true" value="" name="mobnumber" maxlength="11" pattern="[0-9]+" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                       <div class="form-group-inner">
